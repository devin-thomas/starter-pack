...
You can use a computer, an already working remote harness, or a phone app with connected tools that can build and deploy your project. Phone-only deployment is possible. If those connections are not ready, you can save this extra credit for later; Computer Setup can wait until Phase 2.

<details class="phase-extra-credit">
<summary>Can I do the extra credit entirely from my phone?</summary>

Yes, with the right connections. I tested a simple website deployment from ChatGPT on my phone. Your companion should check the tools available in your conversation before choosing a route.
