...
- **Gemini:** use Spark for your Phase 1 companion work. For agent-driven deployment, continue in Antigravity on your computer or through your existing Antigravity browser connection. For a static file upload, use the Cloudflare iPhone guide with files from Gemini or any other agent.
